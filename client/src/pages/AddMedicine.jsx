...
const AddMedicine = () => {
  ...
  const handleFormSubmit = async (formData) => {
    ...
    try {
      ...
      toast.success('Medicine created successfully with alarm schedule!');
      navigate('/medicines');
    } catch (err) {
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-0.5">
                Enroll a new pill, capsule, or syrup into your active daily reminder schedule.
              </p>
            </div>
          </div>

          <MedicineForm onSubmit={handleFormSubmit} isSubmitting={isSubmitting} />
        </main>
      </div>
